						...
						<table width=700 height="460" border="0" align="center">
							<tr valign="middle">
								<td height="50" width="700" align="right" valign="middle"
									colspan="4" align="center">-상품 목록-&nbsp; <a
									href="javascript:searchPrice('<%=category%>','1~3')"> [3만원
										미만] </a> <a href="javascript:searchPrice('<%=category%>','3~5')">
										[3~5만원] </a> <a
									href="javascript:searchPrice('<%=category%>','5~7')">
										[5~7만원] </a> <a
									href="javascript:searchPrice('<%=category%>','7~10')">
										[7~10만원] </a> <a
									href="javascript:searchPrice('<%=category%>','10')"> [10만원
										이상] </a> <a href="javascript:searchPrice('<%=category%>','all')">
										[전체 보기] </a>
								</td>
							</tr>
 --%>
						...
						<table border="0">
							<%-- <tr>
								<c:choose>
									...
									<c:otherwise>
										<tr class="newitem"  align="center"><td colspan="4"><h2>&nbsp;맥주 신상품</h2></td>
										</tr>
										<c:forEach var="item" items="${requestScope.beerlist}"
											begin="0" end="3">
																...
																href="Goods_Detail.go?item=${item.GOODS_CATEGORY}&gr_goods_num=${item.GOODS_NUM}&isitem=hit&price=${price}">
																	...
																	href="Goods_Detail.go?item=${item.GOODS_CATEGORY}&gr_goods_num=${item.GOODS_NUM}&isitem=other">
																		...
																		href="Goods_Detail.go?item=${item.GOODS_CATEGORY}&gr_goods_num=${item.GOODS_NUM}&isitem=other&price=${price}">
																			...
																			height="130" width="130" border="0" /> <br />${item.GOODS_NAME}<br />
							...
							<tr class="newitem"  align="center"><td colspan="4"><h2>&nbsp;막걸리 신상품</h2></td>
							</tr>
							<tr>
								<c:forEach var="item" items="${requestScope.ricelist}" begin="0"
									end="3">
									<td width="180" valign="top"><br>
										<div align="center">
											<%
							...
							<tr class="newitem"  align="center"><td colspan="4"><h2>&nbsp;와인 신상품</h2></td>
							</tr>
							<tr>
								<c:forEach var="item" items="${requestScope.winelist}" begin="0"
									end="3">
							...
							<tr class="newitem"  align="center"><td colspan="4"><h2>&nbsp;위스키 신상품</h2></td>
							</tr>
							<tr>
								<c:forEach var="item" items="${requestScope.whiskeylist}"
									begin="0" end="3">
